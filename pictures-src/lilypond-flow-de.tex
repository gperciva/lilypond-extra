...
\newcommand*{\dedEditor}{Spezieller Editor}
\newcommand*{\genEditor}{Allgemeiner editor}
\newcommand*{\IDE}{IDE}
\newcommand*{\lilyInputFiles}{LilyPond-Eingabedatei(en)}
\newcommand*{\lilyCompile}{LilyPond kompiliert Datei(en)}
\newcommand*{\otherFiles}{Andere}
